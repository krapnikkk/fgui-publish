package fairygui
{
   ...
   public class GObject extends EventDispatcher
   {
      ...
      public final function get xMin() : Number
      {
         return !!_pivotAsAnchor?_x - _width * _pivotX:Number(_x);
      }
      
      public final function set xMin(param1:Number) : void
      {
         if(_pivotAsAnchor)
         {
      ...
      public final function get yMin() : Number
      {
         return !!_pivotAsAnchor?_y - _height * _pivotY:Number(_y);
      }
      
      public final function set yMin(param1:Number) : void
      {
         if(_pivotAsAnchor)
         {
      ...
      public function setSize(param1:Number, param2:Number, param3:Boolean = false) : void
      {
         ...
         if(_rawWidth != param1 || _rawHeight != param2)
         {
            ...
            {
               _parent.setBoundsChangedFlag();
               _relations.onOwnerSizeChanged(_loc5_,_loc4_,_pivotAsAnchor || !param3);
               if(_group != null)
               {
      ...
      public final function get pivotAsAnchor() : Boolean
      {
      ...
      private function updatePivotOffset() : void
      {
         ...
         if(_pivotX != 0 || _pivotY != 0)
         {
            _loc5_ = this.normalizeRotation;
            if(_loc5_ != 0 || _scaleX != 1 || _scaleY != 1)
            {
               _loc10_ = _loc5_ * 0.0174532925199433;
               _loc6_ = Math.cos(_loc10_);
               _loc8_ = Math.sin(_loc10_);
               _loc1_ = _scaleX * _loc6_;
               _loc2_ = _scaleX * _loc8_;
               _loc3_ = _scaleY * -_loc8_;
               _loc4_ = _scaleY * _loc6_;
               _loc7_ = _pivotX * _width;
               _loc9_ = _pivotY * _height;
               _pivotOffsetX = _loc7_ - (_loc1_ * _loc7_ + _loc3_ * _loc9_);
               _pivotOffsetY = _loc9_ - (_loc4_ * _loc9_ + _loc2_ * _loc7_);
            }
            else
            {
               _pivotOffsetX = 0;
      ...
      public function getGear(param1:int) : GearBase
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = GearBase.create(this,param1);
      ...
      private function checkGearDisplay() : void
      {
         ...
         if(_gears[8] != null)
         {
            _loc1_ = GearDisplay2(_gears[8]).evaluate(_loc1_);
         }
      ...
      public final function get gearDisplay() : GearDisplay
      {
      ...
      public final function get asTree() : GTree
      {
      ...
      public final function get treeNode() : GTreeNode
      {
         return _treeNode;
      }
      ...
      public function handleControllerChanged(param1:Controller) : void
      {
         ...
         while(_loc2_ <= 9)
         {
            _loc3_ = _gears[_loc2_];
            if(_loc3_ != null && _loc3_.controller == param1)
            {
               _loc3_.apply();
            }
            _loc2_++;
      ...
      public function setup_beforeAdd(param1:XML) : void
      {
         ...
         _loc2_ = param1.@xy;
         _loc3_ = _loc2_.split(",");
         this.setXY(parseInt(_loc3_[0]),parseInt(_loc3_[1]));
         _loc2_ = param1.@size;
         if(_loc2_)
         {
            _loc3_ = _loc2_.split(",");
            initWidth = parseInt(_loc3_[0]);
            initHeight = parseInt(_loc3_[1]);
            setSize(initWidth,initHeight,true);
         }
         _loc2_ = param1.@restrictSize;
         if(_loc2_)
         {
            _loc3_ = _loc2_.split(",");
            minWidth = parseInt(_loc3_[0]);
            maxWidth = parseInt(_loc3_[1]);
            minHeight = parseInt(_loc3_[2]);
            maxHeight = parseInt(_loc3_[3]);
         }
         _loc2_ = param1.@scale;
         if(_loc2_)
         {
            _loc3_ = _loc2_.split(",");
            setScale(parseFloat(_loc3_[0]),parseFloat(_loc3_[1]));
         }
         _loc2_ = param1.@rotation;
         if(_loc2_)
         {
            this.rotation = parseFloat(_loc2_);
         }
         _loc2_ = param1.@alpha;
         if(_loc2_)
         {
            this.alpha = parseFloat(_loc2_);
         }
         _loc2_ = param1.@pivot;
         if(_loc2_)
         {
            _loc3_ = _loc2_.split(",");
            _loc2_ = param1.@anchor;
            this.setPivot(parseFloat(_loc3_[0]),parseFloat(_loc3_[1]),_loc2_ == "true");
         }
         ...
         if(_loc2_)
         {
            this.blendMode = _loc2_;
         }
         _loc2_ = param1.@filter;
         if(_loc2_)
         {
            var _loc6_:* = _loc2_;
            if("color" === _loc6_)
            {
               _loc2_ = param1.@filterData;
               _loc3_ = _loc2_.split(",");
               _loc5_ = new ColorMatrix();
               _loc5_.adjustBrightness(parseFloat(_loc3_[0]));
               _loc5_.adjustContrast(parseFloat(_loc3_[1]));
               _loc5_.adjustSaturation(parseFloat(_loc3_[2]));
               _loc5_.adjustHue(parseFloat(_loc3_[3]));
               _loc4_ = new ColorMatrixFilter(_loc5_);
               this.filters = [_loc4_];
            }
         }
         _loc2_ = param1.@customData;
         if(_loc2_)
         {
            this.data = _loc2_;
         }
      ...
      {
         var _loc4_:int = 0;
         var _loc3_:String = param1.@group;
         if(_loc3_)
         {
            _group = _parent.getChildById(_loc3_) as GGroup;
         }
         var _loc2_:Object = param1.elements();
         var _loc7_:int = 0;
         var _loc6_:* = _loc2_;
         for each(var _loc5_ in _loc2_)
         {
            _loc4_ = GearBase.getIndexByName(_loc5_.name().localName);
            if(_loc4_ != -1)
            {
               getGear(_loc4_).setup(_loc5_);
            }
         }
      }
      ...
      private function __mousemove(param1:MouseEvent) : void
      {
         ...
         if(GRoot.touchPointInput)
         {
            _loc3_ = UIConfig.touchDragSensitivity;
            if(_touchDownPoint != null && Math.abs(_touchDownPoint.x - TouchEvent(param1).stageX) < _loc3_ && Math.abs(_touchDownPoint.y - TouchEvent(param1).stageY) < _loc3_)
            {
               return;
            }
         }
         ...
         {
            _loc3_ = UIConfig.clickDragSensitivity;
            if(_touchDownPoint != null && Math.abs(_touchDownPoint.x - MouseEvent(param1).stageX) < _loc3_ && Math.abs(_touchDownPoint.y - MouseEvent(param1).stageY) < _loc3_)
            {
               return;
            }
         }
      ...
      public function cancelClick() : void
      {
         ...
         var _loc3_:* = null;
         _buttonStatus = 0;
         var _loc1_:int = GComponent(this).numChildren;
         _loc2_ = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = GComponent(this).getChildAt(_loc2_);
            _loc3_._buttonStatus = 0;
            if(_loc3_ is GComponent)
            {
               _loc3_.cancelClick();
            }
            _loc2_++;
      ...
      private function __dragging(param1:GTouchEvent) : void
      {
         ...
         var _loc2_:Number = param1.stageX - sGlobalDragStart.x + sGlobalRect.x;
         var _loc3_:Number = param1.stageY - sGlobalDragStart.y + sGlobalRect.y;
         if(_dragBounds != null)
         {
            ...
            else if(_loc2_ + sGlobalRect.width > _loc4_.right)
            {
               _loc2_ = _loc4_.right - sGlobalRect.width;
               if(_loc2_ < _loc4_.x)
               {
                  _loc2_ = _loc4_.x;
               }
            ...
            else if(_loc3_ + sGlobalRect.height > _loc4_.bottom)
            {
               _loc3_ = _loc4_.bottom - sGlobalRect.height;
               if(_loc3_ < _loc4_.y)
               {
                  _loc3_ = _loc4_.y;
               }
         ...
         var _loc6_:Point = this.parent.globalToLocal(_loc2_,_loc3_);
         this.setXY(Math.round(_loc6_.x),Math.round(_loc6_.y));
         sUpdateInDragging = false;
         var _loc5_:DragEvent = new DragEvent("dragMoving");
         _loc5_.stageX = param1.stageX;
         _loc5_.stageY = param1.stageY;
         _loc5_.touchPointID = param1.touchPointID;
