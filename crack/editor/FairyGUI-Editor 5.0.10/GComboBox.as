   ...
   public class GComboBox extends GComponent
   {
      ...
      override public function setup_afterAdd(param1:XML) : void
      {
         ...
         if(param1)
         {
            ...
            _loc2_ = param1.@visibleItemCount;
            if(_loc2_)
            {
               _visibleItemCount = parseInt(_loc2_);
            }
            _loc3_ = param1.item;
            _loc4_ = 0;
            var _loc7_:int = 0;
            ...
            {
               _items.push(String(_loc5_.@title));
               _values.push(String(_loc5_.@value));
               _loc2_ = _loc5_.@icon;
               if(_loc2_)
               {
                  if(!_icons)
                  {
                     _icons = new Array(_loc3_.length());
                  }
                  _icons[_loc4_] = _loc2_;
               }
               _loc4_++;
            }
            _loc2_ = param1.@title;
            ...
            {
               this.text = _loc2_;
               _selectedIndex = _items.indexOf(_loc2_);
            }
      ...
      protected function showDropdown() : void
      {
         ...
         if(_itemsUpdated)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc1_ = _list.addItemFromPool();
               _loc1_.name = _loc3_ < _values.length?_values[_loc3_]:"";
               _loc1_.text = _items[_loc3_];
               _loc1_.icon = _icons != null && _loc3_ < _icons.length?_icons[_loc3_]:null;
               _loc3_++;
            }
