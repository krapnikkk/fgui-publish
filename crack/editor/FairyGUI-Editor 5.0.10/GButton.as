   ...
   public class GButton extends GComponent
   {
      ...
      protected function setState(param1:String) : void
      {
         ...
         if(_downEffect == 1)
         {
            ...
            {
               _loc2_ = _downEffectValue * 255;
               _loc3_ = uint((_loc2_ << 16) + (_loc2_ << 8) + _loc2_);
               _loc6_ = 0;
               while(_loc6_ < _loc5_)
               {
                  _loc4_ = this.getChildAt(_loc6_);
                  if(!(_loc4_ is GTextField))
                  {
                     _loc4_.setProp(2,_loc3_);
                  }
                  _loc6_++;
               }
            }
      ...
      override protected function constructFromXML(param1:XML) : void
      {
         ...
         if(_loc2_)
         {
            _downEffect = _loc2_ == "dark"?1:Number(_loc2_ == "scale"?2:0);
