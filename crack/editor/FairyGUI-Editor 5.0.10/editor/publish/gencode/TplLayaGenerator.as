package fairygui.editor.publish.gencode
{
   ...
   public class TplLayaGenerator extends GenerateCodeBase
   {
       
      
      public function TplLayaGenerator()
      {
         super();
      }
      ...
      override public function run() : void
      {
         ...
         var _loc2_:String = loadTemplate("Laya","Component");
         var _loc3_:Array = [];
