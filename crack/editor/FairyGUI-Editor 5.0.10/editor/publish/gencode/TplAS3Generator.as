package fairygui.editor.publish.gencode
{
   ...
   public class TplAS3Generator extends GenerateCodeBase
   {
       
      
      public function TplAS3Generator()
      {
         super();
      }
      ...
      override public function run() : void
      {
         ...
         var _loc2_:String = loadTemplate("AS3","Component");
         var _loc3_:Array = [];
