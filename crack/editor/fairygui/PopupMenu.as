package fairygui
{
   ...
   public class PopupMenu
   {
      ...
      {
         var _loc4_:GButton = _list.addItemFromPool().asButton;
         _loc4_.title = param1;
         _loc4_.data = param2;
         _loc4_.grayed = false;
         _loc4_.useHandCursor = false;
         var _loc3_:Controller = _loc4_.getController("checked");
         if(_loc3_ != null)
         {
      ...
      {
         var _loc5_:GButton = _list.getFromPool().asButton;
         _list.addChildAt(_loc5_,param2);
         _loc5_.title = param1;
         _loc5_.data = param3;
         _loc5_.grayed = false;
         _loc5_.useHandCursor = false;
         var _loc4_:Controller = _loc5_.getController("checked");
         if(_loc4_ != null)
         {
         ...
         if(Mouse.supportsCursor)
         {
            _loc5_.addEventListener("rollOver",__rollOver);
            _loc5_.addEventListener("rollOut",__rollOut);
         }
         return _loc5_;
      }
      ...
      {
         var _loc4_:GButton = _list.getChild(param1).asButton;
         var _loc3_:Controller = _loc4_.getController("checked");
         if(_loc3_ != null)
         {
            if(param2)
      ...
      public function setItemChecked(param1:String, param2:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.selectedIndex = !!param2?2:1;
         }
      }
      ...
      {
         var _loc3_:GButton = _list.getChild(param1).asButton;
         var _loc2_:Controller = _loc3_.getController("checked");
         if(_loc2_ != null)
         {
            return _loc2_.selectedIndex == 2;
         }
         return false;
      }
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:GButton = GButton(_list.getChild(param1));
         if(_loc3_ != null)
         {
            _loc2_ = _list.getChildIndex(_loc3_);
            _list.removeChildToPoolAt(_loc2_);
            return true;
         }
         return false;
      }
      ...
      {
         var _loc3_:GButton = param1.itemObject.asButton;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         var _loc2_:Controller = _loc3_.getController("checked");
         if(_loc2_ != null && _loc2_.selectedIndex != 0)
         {
            if(_loc2_.selectedIndex == 1)
            {
               _loc2_.selectedIndex = 2;
            }
            else
            {
         ...
         if(_loc3_.data != null && !(_loc3_.data is PopupMenu))
         {
            if(_loc3_.data.length == 1)
            {
               _loc3_.data(param1);
            }
            else
