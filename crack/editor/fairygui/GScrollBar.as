package fairygui
{
   ...
   public class GScrollBar extends GComponent
   {
      ...
      private function __gripDragging(param1:GTouchEvent) : void
      {
         ...
         var _loc5_:Point = this.globalToLocal(param1.stageX,param1.stageY);
         if(_vertical)
         {
            _loc3_ = _loc5_.y - _dragOffset.y;
            _loc4_ = _bar.height - _grip.height;
            if(_loc4_ == 0)
            {
            ...
            {
               _target.setPercY((_loc3_ - _bar.y) / _loc4_,false);
            }
         }
         else
         {
            _loc2_ = _loc5_.x - _dragOffset.x;
            _loc4_ = _bar.width - _grip.width;
            if(_loc4_ == 0)
            {
            ...
            {
               _target.setPercX((_loc2_ - _bar.x) / _loc4_,false);
            }
         }
      }
