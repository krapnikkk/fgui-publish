package fairygui
{
   ...
   public class GRoot extends GComponent
   {
      ...
      private function applyScaleFactor() : void
      {
         ...
         var _loc6_:int = _nativeStage.stageWidth;
         var _loc1_:int = _nativeStage.stageHeight;
         if(_designResolutionX == 0 || _designResolutionY == 0)
         {
            this.setSize(_loc6_,_loc1_);
            return;
         }
         var _loc4_:* = int(_designResolutionX);
         var _loc5_:* = int(_designResolutionY);
         if(_loc6_ > _loc1_ && _loc4_ < _loc5_ || _loc6_ < _loc1_ && _loc4_ > _loc5_)
         {
            _loc7_ = _loc4_;
            _loc4_ = _loc5_;
            _loc5_ = _loc7_;
         ...
         if(_screenMatchMode == 0)
         {
            ...
            contentScaleFactor = Math.min(_loc3_,_loc2_);
         }
         else if(_screenMatchMode == 1)
         {
            contentScaleFactor = _loc6_ / _loc4_;
         }
         else
         {
            contentScaleFactor = _loc1_ / _loc5_;
         }
         this.setSize(Math.round(_loc6_ / contentScaleFactor),Math.round(_loc1_ / contentScaleFactor));
      ...
      public function closeAllExceptModals() : void
      {
         var _loc4_:int = 0;
         var _loc1_:* = null;
         var _loc3_:Vector.<GObject> = _children.slice();
      ...
      public function showPopup(param1:GObject, param2:GObject = null, param3:Object = null, param4:Boolean = false) : void
      {
         ...
         {
            _loc8_ = _popupStack.indexOf(param1);
            if(_loc8_ != -1)
            {
         ...
         _loc9_ = _loc10_.x;
         if(_loc9_ + param1.width > this.width)
         {
            _loc9_ = _loc9_ + _loc5_ - param1.width;
         }
         _loc7_ = Number(_loc10_.y + _loc6_);
         if(param3 == null && _loc7_ + param1.height > this.height || param3 == false)
         {
            ...
            {
               _loc7_ = 0;
               _loc9_ = _loc9_ + _loc5_ / 2;
               if(_loc9_ + param1.width > this.width)
               {
                  _loc9_ = this.width - param1.width;
               }
            }
         }
         param1.setXY(int(_loc9_),int(_loc7_));
      }
      ...
      public function hidePopup(param1:GObject = null) : void
      {
         ...
         if(param1 != null)
         {
            _loc3_ = _popupStack.indexOf(param1);
            if(_loc3_ != -1)
            {
               _loc4_ = _popupStack.length - 1;
               while(_loc4_ >= _loc3_)
               {
                  closePopup(_popupStack.pop());
                  _popupCloseFlags.pop();
      ...
      public function showTooltipsWin(param1:GObject, param2:Point = null) : void
      {
         ...
         var _loc3_:Point = this.globalToLocal(_loc5_,_loc4_);
         _loc5_ = _loc3_.x;
         _loc4_ = _loc3_.y;
         if(_loc5_ + _tooltipWin.width > this.width)
         {
            _loc5_ = _loc5_ - _tooltipWin.width - 1;
            if(_loc5_ < 0)
            {
               _loc5_ = 10;
            }
         ...
         if(_loc4_ + _tooltipWin.height > this.height)
         {
            ...
            if(_loc5_ - _tooltipWin.width - 1 > 0)
            {
               _loc5_ = _loc5_ - _tooltipWin.width - 1;
            }
            if(_loc4_ < 0)
      ...
      {
         var _loc3_:Array = _nativeStage.getObjectsUnderPoint(new Point(param1,param2));
         if(!_loc3_ || _loc3_.length == 0)
         {
            return null;
         }
         return ToolSet.displayObjectToGObject(_loc3_[_loc3_.length - 1]);
      }
      ...
      private function __stageMouseDownCapture(param1:MouseEvent) : void
      {
         ...
         while(_loc4_ != _nativeStage && _loc4_ != null)
         {
            ...
            {
               _loc6_ = UIDisplayObject(_loc4_).owner;
               if(_loc6_.touchable && _loc6_.focusable)
               {
                  this.setFocus(_loc6_);
                  break;
               }
            }
         ...
         if(_popupStack.length > 0)
         {
            ...
            while(_loc4_ != _nativeStage && _loc4_ != null)
            {
               if(_loc4_ is UIDisplayObject)
               {
                  _loc2_ = _popupStack.indexOf(UIDisplayObject(_loc4_).owner);
                  if(_loc2_ != -1)
                  {
                     _loc8_ = _popupStack.length - 1;
                     while(_loc8_ > _loc2_)
                     {
                        if(!_popupCloseFlags[_loc8_])
                        {
                           _loc5_ = _popupStack[_loc8_];
                           _popupStack.splice(_loc8_,1);
                           _popupCloseFlags.splice(_loc8_,1);
                           closePopup(_loc5_);
                           _justClosedPopups.push(_loc5_);
                        }
                        _loc8_--;
                     }
                     _loc7_ = true;
