package fairygui.editor.utils
{
   ...
   public class XData
   {
      ...
      {
         var _loc2_:XML = null;
         var _loc1_:XData = null;
         var _loc3_:XMLList = this._xml.children();
