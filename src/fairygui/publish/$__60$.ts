// export class $__60$ extends taskRun
//    {
...
//       private var $__Je$:number;
      
//       private var _pages:Array<Page>;
      
//       private var $__N3$:AtlasSettings;
      
//       public function $__60$()
//       {
//          super();
//          this.$__N3$ = new AtlasSettings();
...
//       private function $__3i$() : void
//       {
//          this.$__8j$++;
//          if(this.$__8j$ >= publishData.atlases.length)
//          {
//             this.allCompleted();
//          }
//          else
...
//          var _loc1_:AtlasItem = publishData.atlases[this.$__8j$];
//          if(_loc1_.index == -1)
//          {
//             this.$__N3$.copyFrom(PublishSettings(publishData.pkg.publishSettings).atlasList[0]);
//             this.$__N3$.packSettings.pot = !_loc1_.npot;
//             this.$__N3$.packSettings.mof = _loc1_.mof;
//             if(_loc1_.items[0].type == FPackageItemType.MOVIECLIP)
//             {
//                this.$__N3$.packSettings.padding = 1;
//                this.$__N3$.packSettings.duplicatePadding = false;
//             }
//          }
//          else
//          {
//             this.$__N3$.copyFrom(PublishSettings(publishData.pkg.publishSettings).atlasList[_loc1_.index]);
//          }
//          var _loc3_:Array<NodeRect> = new Array<NodeRect>();
//          var _loc4_:number = 0;
//          var _loc6_:Boolean = this.$__N3$.packSettings.rotation && (publishData.project.type == ProjectType.COCOS2DX || publishData.project.type == ProjectType.COCOSCREATOR);
...
//       private function $__PK$(param1:NodeRect) : void
//       {
//          var _loc2_:PackSettings = this.$__N3$.packSettings;
...
//       private function $__JL$(param1:Array<Page>) : void
//       {
//          this._pages = param1;
//          if(param1 == null || param1.length > 1 && !this.$__N3$.packSettings.multiPage)
//          {
//             _stepCallback.msgs.length = 0;
//             _stepCallback.addMsg(UtilsStr.formatString(Consts.strings.text122,this.$__N3$.packSettings.maxWidth,this.$__N3$.packSettings.maxHeight));
...
//          var mp:* = undefined;
//          var tmp:Number = NaN;
//          var ai:AtlasItem = publishData.atlases[this.$__8j$];
...
//          var rotationDir:number = publishData.project.type == ProjectType.COCOS2DX || publishData.project.type == ProjectType.COCOSCREATOR || publishData.project.type == ProjectType.EGRET?1:0;
...
//          {
//             this._compressTasks.start(this.$__3i$);
//          }
//          else
//          {
//             this.$__3i$();
...
//       private function $__Ot$(param1:String, param2:number, param3:NodeRect, param4:Point, param5:Point, param6:Boolean) : void
//       {
...
//          }
//          publishData.$__Fc$.push(_loc7_);
//          var _loc8_:FPackageItem = publishData.$__BD$[param1];
//          if(_loc8_)
//          {
//             _loc9_ = _loc7_.concat();
//             _loc9_[0] = _loc8_.id;
//             publishData.$__Fc$.push(_loc9_);
//          }
//       }
      
//       private function pack(param1:Array<NodeRect>) : void
//       {
...
//          WorkerClient.inst.setSharedProperty("settings",this.$__N3$.packSettings);
//          publishData.project.asyncRequest("pack",null,this.$__A$,this.$__A$);
//       }
      
//       private function $__A$() : void
//       {
