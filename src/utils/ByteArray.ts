// see https://help.adobe.com/zh_TW/FlashPlatform/reference/actionscript/3/flash/utils/ByteArray.html
export default class ByteArray {
    ...
    public readMultiByte(length:number,char:string):string{ //使用指定的字元集，從位元組串流讀取指定之長度的多位元組字串。
        // char:unicodeFFFE|unicode|utf-8
        if(char == "utf-8"){
            return this.readUTFBytes(length);
        }
        return "";
